...
import { getPostBySlug } from "@/features/posts/actions/get-post-by-slug";
import fs from "fs";
		...
		>
			...
			<div
				style={{
					...
					right: 0,
					bottom: 0,
					background: "linear-gradient(to bottom, rgba(0, 0, 0, 0.4) 15%, rgba(0,0,0,0) 30%,rgba(0,0,0,0) 70%, rgba(0, 0, 0, 0.4) 85%)",
				}}
			/>
